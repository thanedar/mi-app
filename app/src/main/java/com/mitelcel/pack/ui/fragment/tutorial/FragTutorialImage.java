 ...
 * {@link FragTutorialImage} interface
 * to handle interaction events.
 * Use the {@link FragTutorialImage#newInstance} factory method to
 * create an instance of this fragment.
 */

// Instances of this class are fragments representing a single object in our collection.
public class FragTutorialImage extends AbFragment {
     ...
     *
     * @return A new instance of fragment FragTutorialImage.
     */
    // TODO: Rename and change types and number of parameters
    public static FragTutorialImage newInstance() {
        FragTutorialImage fragment = new FragTutorialImage();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public FragTutorialImage() {
